use revm::interpreter::{gas, opcode as op};
use revm::primitives::{spec_to_generic, SpecId};
...
pub const fn op_info_map(spec_id: SpecId) -> &'static [OpcodeInfo; 256] {
    spec_to_generic!(spec_id, (const { &make_map(<SPEC as revm::primitives::Spec>::SPEC_ID) }))
}
